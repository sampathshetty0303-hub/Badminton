  ...
  return (
    <AppShell>
      <div className="page-header">
        <div><div className="eyebrow">MATCH HISTORY</div><h1>{isAdmin ? "All matches" : "Match history"}</h1><p>{isAdmin ? "Edit or remove matches while their session is still open." : "Track completed games, scorelines, and the session timeline."}</p></div>
